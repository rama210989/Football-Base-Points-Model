...
def plot_team(df_best11):
    """
    Plot a simple football pitch layout with player names and points.
    ...
    ax.plot([0, 1], [0.5, 0.5], color=pitch_color)  # half line
    ...
    # Track position counters (in case more players than coords, cycle)
